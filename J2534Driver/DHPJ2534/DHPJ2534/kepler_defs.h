...
#define COMM_INIT_TIMEOUT 2000	// we wait 2 seconds for Comm thread to initialize Kepler (though it normally should have been initialized already straight after launching the DLL)

#define KEPLER_FIRMWARE_VERSION "01.16"	
#define KEPLER_DLL_VERSION	"00.10"
#define KEPLER_J2534_API_VERSION "04.04"
